...
local function a(b,c)return'{'..'  "slot": '..c..','..'  "getHeaderResponse": '..b..'}'end;local function d(e)local f=''local g='0'for h,i in pairs(e)do if tonumber(i)>tonumber(g)then f=h;g=i end end;return f,g end;local function j(k,f,g,l,m,n,o,p)local q=k..f;local r=g;if tonumber(m)>tonumber(g)then q=l;r=m end;redis.call('COPY',q,n,'REPLACE')redis.call('EXPIRE',n,p)redis.call('SET',o,r,'EX',p)return r end;local function s(t,u)redis.setresp(3)local e=redis.call('HGETALL',t[1]).map;local f,g=d(e)local v=redis.call('GET',t[2])or'0'redis.call('PUBLISH','lualog','** Top bid: '..f..' '..g..' Floor bid: '..v)local w=redis.call('GET',t[5])or'0'local x=j(u[1],f,g,t[3],v,t[4],t[5],u[2])if x~=w then local y=redis.call('GET',t[4])local z=a(y,u[4])redis.call('PUBLISH',u[3],z)end;return true end;local function A(t,u)redis.setresp(3)local e=redis.call('HGETALL',t[1]).map;local f,g=d(e)local v=redis.call('GET',t[2])or'0'redis.call('PUBLISH','lualog','** Received bid '..u[2]..' from '..u[1]..' with cancellations '..u[6])redis.call('PUBLISH','lualog','Top bid: '..f..' '..g..' Floor bid: '..v)local B={false,false,false,g,g}if u[6]=='0'and tonumber(u[2])<tonumber(v)then redis.call('PUBLISH','lualog','Bid '..u[2]..' is lower than floor bid '..v)return B end;redis.call('SET',t[3],u[5],'EX',u[7])redis.call('HSET',t[4],u[1],u[4])redis.call('EXPIRE',t[4],u[7])redis.call('HSET',t[1],u[1],u[2])redis.call('EXPIRE',t[1],u[7])B[1]=true;e[u[1]]=u[2]local C,x=d(e)B[4]=x;redis.call('PUBLISH','lualog','Top bid '..g..' -> '..x)if x==g then redis.call('PUBLISH','lualog','Done - Top+floor unchanged')return B end;B[2]=true;B[3]=x==u[2]j(u[3],C,x,t[7],v,t[5],t[6],u[7])local D=a(u[5],u[9])redis.call('PUBLISH',u[8],D)if u[6]~='0'or tonumber(u[2])<tonumber(v)then redis.call('PUBLISH','lualog','Done - Top updated, floor unchanged')return B end;redis.call('COPY',t[3],t[7],'REPLACE')redis.call('EXPIRE',t[7],u[7])redis.call('SET',t[2],u[2],'EX',u[7])redis.call('PUBLISH','lualog','Done - Top+floor updated to '..u[2])return B end;redis.register_function('updateTopBid',s)redis.register_function('processBidAndUpdateTopBid',A)
`
